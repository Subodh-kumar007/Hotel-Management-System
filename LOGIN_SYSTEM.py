...
from HOME_PAGE import HotelManagementSystem
#def main():
    #pass
class Login_window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="Image/taj.jpg")
        lbl_bg=Label(self.root,image=self.bg)
        lbl_bg.place(x=0,y=0,relwidth=1,relheight=1)
        frame = Frame(self.root,bg="black")
        frame.place(x=600,y=150,width=340,height=450)        
        img1=Image.open("Image/LoginIconAppl.png")
...
##################### BUTTON ################################
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            conn = mysql.connector.connect(host="localhost", user="root",password="123456",database="hotelmanagement")
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                btn=Button(self.root2,text="RESET",command=self.reset_password_data,font=("arial",15,"bold"),fg="white",bg="green",cursor="hand2")
...
class Register:
    def __init__(self,root):
        ...
        ###### BG IMAGE ##########
        self.bg=ImageTk.PhotoImage(file="Image/hackers2.jpg")
        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relheight=1,relwidth=1)
        ########## LEFT IMAGE #############
        self.bg1=ImageTk.PhotoImage(file="Image/LoveSove.jpg")
        ...
        ########### BUTTON #############
        img = Image.open("Image/register.jpg")
        ...
        b1.place(x=30,y=460)
        img1 = Image.open("Image/loginpng.png")
        ...
        img2 = Image.open("Image/exit.jpg")
