    ...
    def add_customer_data(self):
        ...
        if contact == "" or checkin == "" or checkout == "" or room_type == "" or room_available == "" or meal == "" or no_of_days == "" or paid_tax == "" or sub_total == "" or total == "":
            ...
            try:
                ...
                query = "INSERT INTO room (contact, CheckIn, CheckOut, room_type, roomno, Meal, No_Of_Days, paid_tax, sub_total, total) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        ...
        if self.var_roomno.get() == "":
            ...
            try:
                ...
                if room_row is None:
                    ...
                    update_query = "UPDATE room SET contact = %s, checkin = %s, checkout = %s, room_type = %s, Meal = %s, No_Of_Days = %s, paid_tax = %s, sub_total = %s, total = %s WHERE roomno = %s"
                    update_values = (
